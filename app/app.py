...
/* ── DARK MODE override ───────────────────────────────────────── */
/* Strategy: target BOTH OS-level dark AND Streamlit's manual dark   */
/* Streamlit sets data-theme="dark" on <html> when dark is chosen    */

/* Shared dark-mode rules (applied via both selectors below) */
@media (prefers-color-scheme: dark) {
    ...
    .main .block-container span,
    .main .block-container div,
    .main .block-container label { color: rgba(250,250,250,0.87); }
    input, textarea {
        color: rgba(250,250,250,0.87) !important;
        background-color: #262730 !important;
    }
...
/* This fires when the user picks Dark in Streamlit's theme switcher */
...
/* Main content area text in Streamlit dark mode */
...
/* Slider label/value in dark mode */
[data-theme="dark"] .stSlider label,
[data-theme="dark"] .stSlider [data-testid="stTickBarMin"],
[data-theme="dark"] .stSlider [data-testid="stTickBarMax"] {
    color: rgba(250,250,250,0.87) !important;
}
...
/* Section headers / st.markdown text */
